...
bc_policy = joblib.load(
    "/scratch/hdd001/home/kamyar/output/paper-version-hc-bc/paper_version_hc_bc_2019_05_19_00_32_05_0000--s-0/params.pkl"
)["exploration_policy"]
bc_policy = MakeDeterministic(bc_policy)
bc_policy.to(ptu.device)

dagger_policy = joblib.load(
    "/scratch/hdd001/home/kamyar/output/dagger-halfcheetah/dagger_halfcheetah_2019_08_20_16_30_36_0000--s-0/params.pkl"
)["exploration_policy"]
dagger_policy = MakeDeterministic(dagger_policy)
dagger_policy.to(ptu.device)

irl_policy = joblib.load("/scratch/hdd001/home/kamyar/output/hc_airl_ckpt/params.pkl")[
    "exploration_policy"
]
...
eval_sampler = PathSampler(
    env, bc_policy, 20000, 1000, no_terminal=False, render=False, render_kwargs={}
)
...
eval_sampler = PathSampler(
    env, dagger_policy, 20000, 1000, no_terminal=False, render=False, render_kwargs={}
)
...
eval_sampler = PathSampler(
    env, irl_policy, 20000, 1000, no_terminal=False, render=False, render_kwargs={}
)
